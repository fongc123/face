...
if __name__ == "__main__":
    ...
    # parser.add_argument('-u', '--sql_user', type=str, default='sa', help='MySQL user.')
    # parser.add_argument('-pw', '--sql_pass', type=str, default='gadvision', help='MySQL password.')
    # parser.add_argument('-db', '--sql_db', type=str, default='ACCESSAI', help='MySQL database.')
    # parser.add_argument('-t', '--sql_table', type=str, default='G3TRANS', help='MySQL table.')
